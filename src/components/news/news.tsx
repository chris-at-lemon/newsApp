...
function News() {
  ...
  return (
    <div className="container">
      ...
      <div className="row">
        <div
          className={`col col-articleList ${
            menuIsActive ? "isActive" : "isInactive"
          }`}
        >
            ...
            {paginatedPosts &&
              paginatedPosts.map((article, i: number) => {
                return (
                  ...
                  >
                    <div className="readIconContainer">
                      {article.read && (
                        <FontAwesomeIcon
            ...
            {selectedArticle && (
              <article>
                <div className="fullArticleContainer">
                  ...
                  <div className="metaDataContainer">
                    <div className="articleDate">
                      {dayjs(selectedArticle.publishedAt).format("DD/MM/YYYY")}
                    </div>
                    <div className="interactionContainer">
                      <button
                        onClick={() => fn.handleReadStatus(selectedArticle.id)}
                      ...
                      |{" "}
                      <button
                        onClick={() => fn.handleFavStatus(selectedArticle.id)}
                        className="btn btn-set-fav"
                      >
